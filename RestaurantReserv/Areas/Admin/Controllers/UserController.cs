...
namespace RestaurantReserv.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,Password,Fullname")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,Password,Fullname")] User user)
        {
            if (ModelState.IsValid)
            {
